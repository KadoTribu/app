...
import { home, people, logOut, person } from 'ionicons/icons';
...
@Component({
  ...
  standalone: true,
  imports: [IonApp, IonRouterOutlet, IonSplitPane, IonMenu, IonHeader, IonToolbar, IonTitle, IonContent, IonList, IonMenuToggle, IonItem, IonIcon, IonLabel, CommonModule],
})
export class AppComponent {
  ...
  constructor() {
    addIcons({ home, people, logOut, person });
    this.initializeApp();
  }
